      ...
      {mode === 'paste' ? (
        <div>
          <textarea
            ...
            className="w-full border border-rule-strong bg-ink-sunk p-3 font-serif text-body text-paper placeholder:text-paper-low focus:border-signal focus:outline-none"
          />
        ...
        <Mono className="text-micro text-paper-low">fetching…</Mono>
      ) : (
        <div>
